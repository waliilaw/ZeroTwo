...
const categories = ["All", "Stickers", "Posters", "Bookmarks", "Coasters"]
const subcategories = [
  "All",
  "Demon Slayer",
  "Dragon Ball",
...
export default function ShopCollectionPage() {
  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter(
        (product) =>
          ...
          product.tags.some((tag : any ) => tag.toLowerCase().includes(query)) ||
    ...
    if (!selectedStockOptions.includes("All")) {
      result = result.filter((product) => selectedStockOptions.includes(product.stockStatus))
    }
      ...
      <section className="relative pt-32 pb-12 bg-muted/30 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <span className="text-retro-purple">Shop</span> Collection
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Browse our complete collection of premium anime merchandise with a retro twist.
            </motion.p>
      ...
      <section ref={ref} className="py-12 bg-background">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="All" className="mb-8" onValueChange={handleCategoryChange}>
            <TabsList className="w-full justify-start overflow-x-auto flex-nowrap mb-4 bg-transparent">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="hidden lg:block w-64 space-y-6">
              ...
              <div>
                ...
                <div className="px-2">
                  <Slider defaultValue={[0, 25]} max={25} step={0.5} value={priceRange} onValueChange={setPriceRange} />
            ...
            <div className="flex-1">
                  ...
                  <Sheet>
                    ...
                    <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                      <SheetHeader>
                        ...
                        <SheetDescription className="font-retro">Refine your product search</SheetDescription>
                      </SheetHeader>

                      <div className="py-4 space-y-6">
                        <Accordion type="single" collapsible className="w-full">
                          <AccordionItem value="categories">
                            <AccordionTrigger className="font-pixel text-sm">Categories</AccordionTrigger>
                            <AccordionContent>
              ...
              {currentProducts.length > 0 ? (
                    ...
                    <motion.div key={product.id} variants={itemVariants}>
                      {gridView === "grid" ? (
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 p-4 border rounded-lg bg-background pixel-borders-sm">
                          ...
                          <div className="flex-1">
                            <div className="font-retro text-xs text-retro-cyan mb-1">{product.subcategory}</div>
                            <h3 className="font-pixel text-lg mb-2">{product.name}</h3>
                            <p className="font-retro text-sm text-muted-foreground mb-3">{product.description}</p>
                            <div className="flex items-center gap-2 mb-3">
                              <div className="flex items-center space-x-1">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <svg
                                    key={star}
                                    className={`w-4 h-4 ${star <= product.rating ? "text-retro-yellow" : "text-muted-foreground"}`}
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                  >
                              ...
                              <span className="font-retro text-xs text-muted-foreground">({product.rating})</span>
                            </div>
                            <div className="flex flex-wrap items-center justify-between">
                              <p className="font-silkscreen text-lg text-retro-yellow">${product.price.toFixed(2)}</p>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="font-pixel text-xl mb-2">No products found</h3>
